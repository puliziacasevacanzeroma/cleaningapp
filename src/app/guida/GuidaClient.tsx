...
const APP_ICON = "data:image/png;base64,";
...
function ScreenInstallIphone() {
  ...
  useEffect(() => {
    if (!vis) { setPhase(0); return; }
    const seq = [0,0,1800,3500,5500,7500,8500,9500,11000];
    const timers = seq.map((t,i)=>setTimeout(()=>setPhase(i),t));
    const loop = setInterval(()=>{ setPhase(0); seq.forEach((t,i)=>{ timers.push(setTimeout(()=>setPhase(i),t)); }); },14500);
    return ()=>{ timers.forEach(clearTimeout); clearInterval(loop); };
  },[vis]);
  ...
  const activeRef = phase<=1 ? centerRef : phase<=2 ? shareRef : phase<=4 ? addHomeRef : addBtnRef;
  ...
  return (
    <div ref={ref} style={{position:"relative",height:"100%",background:phase>=7?"transparent":"#f2f2f7",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      <div ref={centerRef} style={{position:"absolute",left:"50%",top:"45%",width:1,height:1,pointerEvents:"none"}}/>
      ...
      {phase>=5 && phase<7 && (
        ...
        /* ═══ SCHERMATA HOME IPHONE ═══ */
        <div style={{background:"linear-gradient(180deg,#0a1628 0%,#1a2744 30%,#2a3a5c 100%)",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s"}}>
          {/* Status bar iOS */}
          <div style={{padding:"4px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
            <span style={{fontSize:10,color:"white",fontWeight:600}}>9:41</span>
            <div style={{width:80,height:20,borderRadius:14,background:"#000",margin:"0 auto",position:"relative"}}>
              <div style={{position:"absolute",right:8,top:5,width:8,height:8,borderRadius:"50%",background:"#1a2744",border:"1.5px solid #333"}}/>
            </div>
            <div style={{display:"flex",gap:3,alignItems:"center"}}>
              <svg style={{width:12,height:9}} fill="white" viewBox="0 0 24 18"><path d="M1 6l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93-.07 7.08-.07 1 6zm4 4l2 2a7.07 7.07 0 0110 0l2-2C15.68 6.68 8.32 6.68 5 10zm4 4l3 3 3-3a4.24 4.24 0 00-6 0z"/></svg>
              <svg style={{width:16,height:10}} viewBox="0 0 25 12" fill="none"><rect x="0.5" y="0.5" width="21" height="11" rx="2" stroke="white" opacity="0.35"/><rect x="2" y="2" width="17" height="8" rx="1" fill="white"/><path d="M23 4v4.5" stroke="white" opacity="0.4" strokeWidth="1.5" strokeLinecap="round"/></svg>
            </div>
          </div>

          {/* App grid — 4 colonne stile iOS */}
          <div style={{flex:1,padding:"10px 16px",display:"flex",flexDirection:"column",justifyContent:"center",gap:14}}>
            {/* Riga 1 */}
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10}}>
              {[
                {name:"Impostaz.",bg:"#8e8e93",icon:"⚙️"},
                {name:"YouTube",bg:"white",icon:"▶️"},
                {name:"Instagram",bg:"linear-gradient(135deg,#f09433,#e6683c,#dc2743,#bc1888)",icon:<span style={{color:"white",fontSize:16}}>📷</span>},
                {name:"Orologio",bg:"#000",icon:<span style={{color:"white",fontSize:14}}>🕐</span>},
              ].map((a,i)=>(<div key={i} style={{textAlign:"center"}}><div style={{width:44,height:44,borderRadius:12,background:a.bg,margin:"0 auto 3px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,boxShadow:"0 1px 4px rgba(0,0,0,0.2)"}}>{a.icon}</div><span style={{fontSize:7,color:"white"}}>{a.name}</span></div>))}
            </div>
            {/* Riga 2 */}
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10}}>
              {[
                {name:"Amazon",bg:"white",icon:<span style={{fontSize:12,fontWeight:700}}>a</span>},
                {name:"Foto",bg:"linear-gradient(135deg,#ff6b6b,#ffd93d,#6bcb77,#4d96ff)",icon:<span style={{color:"white",fontSize:14}}>🌸</span>},
                {name:"WhatsApp",bg:"#25d366",icon:<span style={{color:"white",fontSize:16}}>📱</span>},
                {name:"Telegram",bg:"#0088cc",icon:<span style={{color:"white",fontSize:14}}>✈️</span>},
              ].map((a,i)=>(<div key={i} style={{textAlign:"center"}}><div style={{width:44,height:44,borderRadius:12,background:a.bg,margin:"0 auto 3px",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.2)"}}>{a.icon}</div><span style={{fontSize:7,color:"white"}}>{a.name}</span></div>))}
            </div>
            {/* Riga 3 */}
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10}}>
              {[
                {name:"App Store",bg:"#007aff",icon:<span style={{color:"white",fontSize:16,fontWeight:700}}>A</span>},
                {name:"Spotify",bg:"#1db954",icon:<span style={{color:"white",fontSize:14}}>🎵</span>},
                {name:"CleaningApp",bg:"transparent",isNew:true,icon:<img src={APP_ICON} style={{width:44,height:44,borderRadius:12}} alt=""/>},
                {name:"Airbnb",bg:"white",icon:<span style={{fontSize:14}}>🏠</span>},
              ].map((a,i)=>(<div key={i} style={{textAlign:"center"}}><div style={{width:44,height:44,borderRadius:12,background:a.bg||"white",margin:"0 auto 3px",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 1px 4px rgba(0,0,0,0.2)",position:"relative",animation:a.isNew?"pulse 1.5s ease-in-out infinite":"none",border:a.isNew?"2px solid rgba(255,255,255,0.5)":"none",overflow:a.bg==="transparent"?"visible":"hidden"}}>{a.icon}{a.isNew&&<div style={{position:"absolute",top:-3,right:-3,width:12,height:12,borderRadius:"50%",background:"#34c759",border:"2px solid #1a2744",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:6,color:"white",fontWeight:900}}>✓</span></div>}</div><span style={{fontSize:7,color:"white",fontWeight:a.isNew?700:400}}>{a.name}</span></div>))}
            </div>
          </div>

          {/* Search bar */}
          <div style={{padding:"0 40px 8px",flexShrink:0}}>
            <div style={{background:"rgba(255,255,255,0.15)",borderRadius:14,padding:"6px 12px",display:"flex",alignItems:"center",justifyContent:"center",gap:4}}>
              <svg style={{width:10,height:10}} fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
              <span style={{fontSize:9,color:"rgba(255,255,255,0.5)"}}>Cerca</span>
            </div>
          </div>

          {/* Dock iOS — 4 app */}
          <div style={{padding:"4px 16px 4px",background:"rgba(255,255,255,0.12)",backdropFilter:"blur(20px)",borderRadius:"20px 20px 0 0",display:"flex",justifyContent:"space-around",flexShrink:0}}>
            {[
              {bg:"#34c759",icon:"📞"},
              {bg:"linear-gradient(135deg,#00d4ff,#0070ff)",icon:"🧭"},
              {bg:"white",icon:"📧"},
              {bg:"#fc3c44",icon:"🎵"},
            ].map((d,i)=>(
              <div key={i} style={{width:44,height:44,borderRadius:12,background:d.bg,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 6px rgba(0,0,0,0.2)"}}>
...
function ScreenInstallAndroid() {
  ...
  /*
    0-1 = Browser con contenuto, cursore dal centro
    2 = Cursore su tre puntini
    3 = Menu aperto
    4 = Auto-scroll menu + evidenzia "Aggiungi a schermata"
    5 = Click su "Aggiungi a schermata Home"
    6 = Dialog conferma
    7 = Click Aggiungi
    8 = Schermata Home con app installata
    9 = Overlay completamento
  */
  useEffect(() => {
    if (!vis) { setPhase(0); return; }
    const seq = [0,0,1800,3500,5000,6500,7500,8500,9500,12000];
    const timers = seq.map((t,i)=>setTimeout(()=>setPhase(i),t));
    const loop = setInterval(()=>{ setPhase(0); seq.forEach((t,i)=>{ timers.push(setTimeout(()=>setPhase(i),t)); }); },15000);
    return ()=>{ timers.forEach(clearTimeout); clearInterval(loop); };
  },[vis]);
  ...
  const centerRef = useRef<HTMLDivElement>(null);
  const activeRef = phase<=1 ? centerRef : phase<=2 ? menuRef : phase<=5 ? addHomeRef : addBtnRef;
  const clicking = [2,5,7].includes(phase);
  const menuOpen = phase>=3 && phase<6;
  const showHome = phase >= 8;

  return (
    <div ref={ref} style={{position:"relative",height:"100%",background:"#fafafa",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      <CompletionOverlay visible={phase>=9} message="App Installata!" />
      <div ref={centerRef} style={{position:"absolute",left:"50%",top:"50%",width:1,height:1,pointerEvents:"none"}}/>
      ...
      {!showHome ? (
        <>
          ...
          {menuOpen && (
            <div ref={menuListRef} style={{position:"absolute",top:32,right:4,bottom:40,background:"white",borderRadius:4,boxShadow:"0 2px 12px rgba(0,0,0,0.2)",width:210,zIndex:10,animation:"fadeIn 0.15s",overflow:"auto",paddingTop:6,paddingBottom:6}}>
              {[
                ...
                {t:"Schede recenti",ic:"M4 6h18V4H4c-1.1 0-2 .9-2 2v11H0v3h14v-3H4V6zm19 2h-6c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1z"},
                {t:"Condividi...",ic:"M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81a3 3 0 10-3-3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9a3 3 0 100 6c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65a2.92 2.92 0 105.84 0z"},
                {t:"Trova nella pagina",ic:"M20.49 19l-5.73-5.73A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.41 0 2.7-.47 3.77-1.24L19 20.49 20.49 19z"},
                {t:"Traduci...",ic:"M12.87 15.07l-2.54-2.51.03-.03A17.52 17.52 0 0014.07 6H17V4h-7V2H8v2H1v2h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12z"},
                {t:"Aggiungi a schermat...",ic:"M18 1.01L6 1c-1.1 0-2 .9-2 2v3h2V5h12v14H6v-1H4v3c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2zM10 15h2V8H5v2h3.59L1 17.59 2.41 19 10 11.41V15z",hl:true},
                ...
                <div key={i} ref={m.hl?addHomeRef:undefined} style={{
                  ...
                  <svg style={{width:16,height:16,flexShrink:0}} viewBox="0 0 24 24" fill={m.hl&&phase>=4?"#1a73e8":"#5f6368"}><path d={m.ic}/></svg>
        ...
        /* ═══ SCHERMATA HOME ANDROID — Samsung style ═══ */
        <div style={{background:"#2d2d2d",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s",position:"relative",overflow:"hidden"}}>
          {/* Cerchio sfumato Samsung */}
          <div style={{position:"absolute",top:"15%",left:"50%",transform:"translateX(-50%)",width:"120%",height:"65%",borderRadius:"50%",background:"radial-gradient(ellipse,rgba(60,60,60,0.8) 0%,rgba(45,45,45,0.4) 50%,transparent 70%)",pointerEvents:"none"}}/>
          
          {/* Status bar */}
          <div style={{padding:"6px 12px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0,position:"relative",zIndex:1}}>
            <span style={{fontSize:10,color:"white",fontWeight:600}}>18:32</span>
            <div style={{display:"flex",gap:2,alignItems:"center"}}>
              <span style={{fontSize:7,color:"white"}}>5G</span>
              <svg style={{width:10,height:10}} fill="white" viewBox="0 0 24 24" opacity="0.7"><path d="M2 22h20V2z"/></svg>
              <div style={{padding:"1px 3px",borderRadius:3,border:"1.5px solid #4ade80",fontSize:7,color:"#4ade80",fontWeight:700}}>57</div>
            </div>
          </div>

          {/* App grid — 2 colonne come screenshot Samsung */}
          <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 40px",position:"relative",zIndex:1}}>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"18px 40px",width:"100%",maxWidth:240}}>
              {[
                {name:"ChatGPT",bg:"white",icon:<span style={{fontSize:10,fontWeight:800,color:"#1a1a1a"}}>GPT</span>,badge:null},
                {name:"CleaningApp",bg:"transparent",icon:<img src={APP_ICON} style={{width:48,height:48,borderRadius:14}} alt=""/>,badge:"chrome",isNew:true},
                {name:"Claude",bg:"#f97316",icon:<span style={{fontSize:18,color:"white"}}>✦</span>,badge:null},
                {name:"Booking",bg:"#003580",icon:<span style={{fontSize:9,color:"white",fontWeight:800}}>B.</span>,badge:"chrome"},
                {name:"WhatsApp",bg:"#25d366",icon:<span style={{fontSize:18,color:"white"}}>📱</span>,badge:null},
                {name:"Gmail",bg:"white",icon:<span style={{fontSize:16}}>📧</span>,badge:null},
                {name:"Maps",bg:"white",icon:<span style={{fontSize:16}}>📍</span>,badge:null},
                {name:"YouTube",bg:"#ff0000",icon:<span style={{fontSize:12,color:"white",fontWeight:900}}>▶</span>,badge:null},
              ].map((app,i)=>(
                <div key={i} style={{textAlign:"center"}}>
                  <div style={{
                    ...
                    position:"relative",
                    animation:app.isNew?"pulse 1.5s ease-in-out infinite":"none",
                    border:app.isNew?"2px solid rgba(255,255,255,0.5)":"none",
                    overflow:app.bg==="transparent"?"visible":"hidden"
                  }}>
                    {app.icon}
                    {app.badge==="chrome" && (
                      <div style={{position:"absolute",bottom:-2,right:-2,width:16,height:16,borderRadius:"50%",background:"white",boxShadow:"0 1px 3px rgba(0,0,0,0.3)",display:"flex",alignItems:"center",justifyContent:"center"}}>
                        <span style={{fontSize:8}}>🌐</span>
                      </div>
                    )}
                    {app.isNew && (
                      <div style={{position:"absolute",top:-3,right:-3,width:14,height:14,borderRadius:"50%",background:"#4ade80",border:"2px solid #2d2d2d",display:"flex",alignItems:"center",justifyContent:"center"}}>
                        <span style={{fontSize:7,color:"white",fontWeight:900}}>✓</span>
                      </div>
                    )}
                  </div>
                  <span style={{fontSize:8,color:"white",fontWeight:app.isNew?700:400,textShadow:"0 1px 3px rgba(0,0,0,0.8)",maxWidth:70,display:"block",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{app.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Page dots */}
          <div style={{display:"flex",justifyContent:"center",gap:4,padding:"8px 0",flexShrink:0,position:"relative",zIndex:1}}>
            {[0,1,2,3,4].map(i=><div key={i} style={{width:i===0?6:4,height:4,borderRadius:2,background:i===0?"white":"rgba(255,255,255,0.3)"}}/>)}
          </div>

          {/* Dock Samsung — 5 app */}
          <div style={{padding:"8px 12px 6px",display:"flex",justifyContent:"space-around",alignItems:"center",flexShrink:0,position:"relative",zIndex:1}}>
            {[
              {bg:"#34c759",icon:"📞"},
              {bg:"#5b9bd5",icon:"💬"},
              {bg:"white",icon:"🌐"},
              ...
              <div key={i} style={{width:44,height:44,borderRadius:14,background:d.bg,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 6px rgba(0,0,0,0.3)"}}>
                <span style={{fontSize:18}}>{d.icon}</span>
              </div>
            ))}
          </div>

          {/* Android nav bar Samsung — 3 linee, cerchio, freccia */}
          <div style={{padding:"6px 0 8px",display:"flex",justifyContent:"center",gap:50,flexShrink:0,position:"relative",zIndex:1}}>
