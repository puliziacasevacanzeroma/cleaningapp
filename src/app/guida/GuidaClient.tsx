...
const APP_ICON = "data:image/png;base64,";
  ...
  return (
    <div ref={ref} style={{position:"relative",height:"100%",background:"#f2f2f7",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      {phase>=5 && phase<7 && (
        ...
        <div style={{background:"linear-gradient(135deg,#667eea 0%,#764ba2 100%)",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s"}}>
          {/* Status bar */}
          <div style={{padding:"6px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
            <span style={{fontSize:10,color:"white",fontWeight:600}}>9:41</span>
            <div style={{display:"flex",gap:3,alignItems:"center"}}>
              <svg style={{width:12,height:10}} fill="white" viewBox="0 0 24 24"><path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9z"/></svg>
              <svg style={{width:14,height:10}} fill="white" viewBox="0 0 24 24"><path d="M2 22h20V2z"/></svg>
            </div>
          </div>
          ...
          <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 20px"}}>
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,width:"100%",maxWidth:280}}>
              {[
                {name:"Safari",bg:"linear-gradient(135deg,#00d4ff,#0070ff)",icon:<span style={{fontSize:18}}>🧭</span>},
                {name:"Messaggi",bg:"#34c759",icon:<span style={{fontSize:18,color:"white"}}>💬</span>},
                {name:"Foto",bg:"linear-gradient(135deg,#ff6b6b,#ffd93d,#6bcb77,#4d96ff)",icon:<span style={{fontSize:16,color:"white"}}>🖼️</span>},
                {name:"Mappe",bg:"linear-gradient(135deg,#34c759,#30d158)",icon:<span style={{fontSize:16}}>🗺️</span>},
                {name:"Mail",bg:"#007aff",icon:<span style={{fontSize:16,color:"white"}}>✉️</span>},
                {name:"Calendario",bg:"white",icon:<span style={{fontSize:14,color:"#ef4444",fontWeight:900}}>24</span>},
                {name:"Note",bg:"#ffd60a",icon:<span style={{fontSize:16}}>📝</span>},
                {name:"WhatsApp",bg:"#25d366",icon:<span style={{fontSize:18,color:"white"}}>📱</span>},
                {name:"Instagram",bg:"linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)",icon:<span style={{fontSize:16,color:"white"}}>📷</span>},
                {name:"Spotify",bg:"#1db954",icon:<span style={{fontSize:16,color:"white"}}>🎵</span>},
                {name:"Airbnb",bg:"white",icon:<span style={{fontSize:16}}>🏠</span>},
                {name:"CleaningApp",bg:"transparent",isNew:true,icon:<img src={APP_ICON} style={{width:48,height:48,borderRadius:12}} alt=""/>},
              ].map((app,i)=>(
                <div key={i} style={{textAlign:"center"}}>
                  <div style={{
                    width:48,height:48,borderRadius:12,margin:"0 auto 3px",
                    background:app.bg||"white",
                    display:"flex",alignItems:"center",justifyContent:"center",
                    boxShadow:"0 2px 8px rgba(0,0,0,0.15)",
                    position:"relative",
                    animation:app.isNew?"pulse 1.5s ease-in-out infinite":"none",
                    border:app.isNew?"2px solid rgba(255,255,255,0.6)":"none"
                  }}>
                    {app.icon}
                    {app.isNew && (
                      <div style={{position:"absolute",top:-4,right:-4,width:12,height:12,borderRadius:"50%",background:"#34c759",border:"2px solid white",display:"flex",alignItems:"center",justifyContent:"center"}}>
          ...
          {/* Dock */}
          <div style={{padding:"6px 16px 10px",background:"rgba(255,255,255,0.15)",backdropFilter:"blur(20px)",borderRadius:"20px 20px 0 0",display:"flex",justifyContent:"space-around",flexShrink:0}}>
            {[
              {icon:"📞",bg:"#34c759"},
              {icon:"💬",bg:"#34c759"},
              {icon:"🧭",bg:"linear-gradient(135deg,#00d4ff,#0070ff)"},
              {icon:"🎵",bg:"#fc3c44"},
            ].map((d,i)=>(
              <div key={i} style={{width:44,height:44,borderRadius:12,background:d.bg,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 6px rgba(0,0,0,0.15)"}}>
  ...
  return (
    <div ref={ref} style={{position:"relative",height:"100%",background:"#fafafa",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      {!showHome ? (
        ...
        <div style={{background:"linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%)",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s",position:"relative"}}>
          {/* Status bar */}
          <div style={{padding:"6px 12px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
            ...
            <div style={{display:"flex",gap:3,alignItems:"center"}}>
              <svg style={{width:10,height:10}} fill="white" viewBox="0 0 24 24"><path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3a4.24 4.24 0 00-6 0zm-4-4l2 2a7.07 7.07 0 0110 0l2-2C15.68 9.68 8.32 9.68 5 13z"/></svg>
              <svg style={{width:12,height:10}} fill="white" viewBox="0 0 24 24"><path d="M2 22h20V2z"/></svg>
          ...
          <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 24px"}}>
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,width:"100%",maxWidth:280}}>
              {[
                {name:"Chrome",bg:"white",icon:<svg style={{width:22,height:22}} viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#fff"/><circle cx="12" cy="12" r="4.5" fill="#fff" stroke="#4285f4" strokeWidth="1"/><path d="M12 7.5A4.5 4.5 0 007.5 12H2a10 10 0 015-8.66z" fill="#ea4335"/><path d="M16.24 9A4.5 4.5 0 0112 16.5l-2.75 4.76A10 10 0 0022 12h-5.5z" fill="#4285f4"/><path d="M7.5 12A4.5 4.5 0 0112 7.5l-2.75-4.76A10 10 0 002 12z" fill="#fbbc05"/><path d="M12 16.5A4.5 4.5 0 017.76 15L5 19.76A10 10 0 0017 19.76L14.24 15A4.49 4.49 0 0112 16.5z" fill="#34a853"/></svg>},
                {name:"Gmail",bg:"white",icon:<span style={{fontSize:18}}>📧</span>},
                {name:"Maps",bg:"white",icon:<span style={{fontSize:18}}>🗺️</span>},
                {name:"Foto",bg:"white",icon:<span style={{fontSize:18}}>🖼️</span>},
                {name:"WhatsApp",bg:"#25d366",icon:<span style={{fontSize:18}}>💬</span>},
                {name:"Telegram",bg:"#0088cc",icon:<span style={{fontSize:18,color:"white"}}>✈️</span>},
                {name:"ChatGPT",bg:"white",icon:<span style={{fontSize:14,fontWeight:700}}>🤖</span>},
                {name:"Claude",bg:"#f97316",icon:<span style={{fontSize:14,color:"white"}}>✦</span>},
                {name:"Banca",bg:"#1a73e8",icon:<span style={{fontSize:16,color:"white"}}>🏦</span>},
                {name:"Spotify",bg:"#1db954",icon:<span style={{fontSize:16,color:"white"}}>🎵</span>},
                {name:"YouTube",bg:"white",icon:<span style={{fontSize:16}}>▶️</span>},
                {name:"CleaningApp",bg:"transparent",isNew:true,icon:<img src={APP_ICON} style={{width:48,height:48,borderRadius:14}} alt=""/>},
              ].map((app,i)=>(
                <div key={i} style={{textAlign:"center"}}>
                  <div style={{
                    ...
                    {app.icon}
                    {app.isNew && (
                      <div style={{position:"absolute",top:-4,right:-4,width:12,height:12,borderRadius:"50%",background:"#34a853",border:"2px solid white",display:"flex",alignItems:"center",justifyContent:"center"}}>
                        <span style={{fontSize:7,color:"white",fontWeight:900}}>✓</span>
                      </div>
                    )}
                  </div>
          ...
          {/* Dock bar in basso */}
          <div style={{padding:"8px 20px 12px",display:"flex",justifyContent:"space-around",alignItems:"center",background:"rgba(0,0,0,0.3)",borderRadius:"20px 20px 0 0",flexShrink:0}}>
            {[
              {icon:"📞",label:"Telefono"},
              {icon:"💬",label:"Messaggi"},
              {icon:"🌐",label:"Chrome"},
              {icon:"📧",label:"Gmail"},
              {icon:"📷",label:"Fotocamera"},
            ].map((d,i)=>(
          ...
          <div style={{padding:"4px 0 6px",display:"flex",justifyContent:"center",gap:40,flexShrink:0}}>
            <div style={{width:12,height:12,borderRadius:2,border:"1.5px solid rgba(255,255,255,0.5)"}}/>
            <div style={{width:12,height:12,borderRadius:"50%",border:"1.5px solid rgba(255,255,255,0.5)"}}/>
            <svg style={{width:12,height:12}} fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="2" viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7"/></svg>
          </div>
        </div>
      )}
    </div>
