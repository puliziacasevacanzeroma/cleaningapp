            ...
            <div style={{display:"flex",flexDirection:"column",gap:6,animation:"fadeIn 0.3s"}}>
              ...
              <div style={{background:"white",borderRadius:10,border:"1px solid #e2e8f0",padding:"10px"}}>
                ...
                <div style={{borderTop:"1px solid #f1f5f9",paddingTop:8,display:"flex",flexDirection:"column",gap:4}}>
                  <button ref={configBtnRef} style={{width:"100%",padding:"8px 0",background:"#f1f5f9",border:"none",borderRadius:8,fontSize:9,fontWeight:600,color:"#475569",cursor:"pointer"}}>Configura Link</button>
                  <p style={{fontSize:7,color:"#94a3b8",margin:0,textAlign:"center"}}>🔄 I calendari si aggiornano automaticamente ogni 30 minuti</p>
                </div>
              </div>
            </div>
          )}
...
function ScreenInstallIphone() {
    ...
    <div style={{height:"100%",background:"#f2f2f7",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:"#f8f8f8",padding:"6px 16px 10px",borderTop:"0.5px solid #c6c6c8",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
        ...
        <div ref={shareRef} style={{padding:4}}>
          <svg style={{width:18,height:18}} fill="none" stroke="#007aff" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <svg style={{width:20,height:20,opacity:0.3}} fill="none" stroke="#007aff" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"/></svg>
    ...
    <div style={{background:"linear-gradient(180deg,#0a1628 0%,#1a2744 30%,#2a3a5c 100%)",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s"}}>
      <div style={{padding:"4px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
        ...
        <div style={{display:"flex",gap:3,alignItems:"center"}}>
          ...
          <svg style={{width:16,height:10}} viewBox="0 0 25 12" fill="none"><rect x="0.5" y="0.5" width="21" height="11" rx="2" stroke="white" opacity="0.35"/><rect x="2" y="2" width="17" height="8" rx="1" fill="white"/></svg>
        </div>
      </div>
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 20px"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,width:"100%",maxWidth:280}}>
          {[
            {name:"Safari",bg:"#007aff"},{name:"Messaggi",bg:"#34c759"},{name:"Foto",bg:"#ff9500"},{name:"Mappe",bg:"#34c759"},
            {name:"Mail",bg:"#007aff"},{name:"Calendario",bg:"white"},{name:"Note",bg:"#ffd60a"},{name:"WhatsApp",bg:"#25d366"},
            {name:"Instagram",bg:"#e1306c"},{name:"Spotify",bg:"#1db954"},{name:"Airbnb",bg:"#ff5a5f"},
            {name:"CleaningApp",bg:"transparent",isNew:true},
          ].map((app,i)=>(
            <div key={i} style={{textAlign:"center"}}>
              <div style={{width:48,height:48,borderRadius:12,margin:"0 auto 3px",background:app.bg,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.15)",position:"relative",animation:app.isNew?"pulse 1.5s ease-in-out infinite":"none",border:app.isNew?"2px solid rgba(255,255,255,0.6)":"none",overflow:"hidden"}}>
                {app.isNew ? <img src={APP_ICON} style={{width:48,height:48,borderRadius:12}} alt="" /> : <span style={{fontSize:18,color:"white"}}>{["\ud83e\udde8","\ud83d\udcac","\ud83d\uddbc\ufe0f","\ud83d\uddfa\ufe0f","\u2709\ufe0f","24","\ud83d\udcdd","\ud83d\udcf1","\ud83d\udcf7","\ud83c\udfb5","\ud83c\udfe0",""][i]}</span>}
                {app.isNew && <div style={{position:"absolute",top:-3,right:-3,width:12,height:12,borderRadius:"50%",background:"#34c759",border:"2px solid white",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:7,color:"white",fontWeight:900}}>\u2713</span></div>}
              </div>
              <span style={{fontSize:7,color:"white",fontWeight:app.isNew?700:400,textShadow:"0 1px 2px rgba(0,0,0,0.3)"}}>{app.name}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div ref={ref} style={{position:"relative",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      {vis && activeRef && !showHome && <SmartCursor targetRef={activeRef} clicking={clicking} visible={phase>=1&&phase<7} />}
      {showHome ? <HomeScreen /> : <BrowserView />}
      {phase>=3 && phase<5 && !showHome && (
        <div style={{position:"absolute",bottom:0,left:0,right:0,top:"15%",background:"#f2f2f7",borderRadius:"12px 12px 0 0",boxShadow:"0 -8px 30px rgba(0,0,0,0.25)",zIndex:10,animation:"slideUp 0.3s ease-out",display:"flex",flexDirection:"column"}}>
          ...
          <div style={{flex:1,overflow:"auto"}}>
            <div style={{background:"white",margin:"8px 10px",borderRadius:10,overflow:"hidden"}}>
              {["Copia","Aggiungi elenco di lettura","Aggiungi segnalibro","Aggiungi ai preferiti","Trova nella pagina","Aggiungi alla schermata Home","Modifica","Stampa"].map((t,i)=>(
                <div key={i} ref={i===5?addHomeRef:undefined} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"11px 14px",borderBottom:i<7?"0.5px solid #e5e5ea":"none",background:i===5&&phase>=4?"#e8f0fe":"white"}}>
                  <span style={{fontSize:10,color:i===5&&phase>=4?"#007aff":"#1c1c1e",fontWeight:i===5&&phase>=4?600:400}}>{t}</span>
                  {i===5 && <svg style={{width:16,height:16}} fill="none" stroke={phase>=4?"#007aff":"#8e8e93"} strokeWidth="1.5" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="4"/><path d="M12 8v8M8 12h8"/></svg>}
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.4)",display:"flex",flexDirection:"column",zIndex:20,animation:"fadeIn 0.3s"}}>
          ...
          <div style={{background:"#f2f2f7",borderRadius:"12px 12px 0 0",overflow:"hidden"}}>
            ...
            <div style={{padding:"16px 16px 20px",display:"flex",alignItems:"center",gap:12}}>
              <div style={{width:44,height:44,borderRadius:10,overflow:"hidden",flexShrink:0,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}>
                <img src={APP_ICON} style={{width:44,height:44}} alt="" />
              </div>
              <div>
...
function ScreenInstallAndroid() {
  ...
  useEffect(() => {
    if (phase === 4 && menuListRef.current) menuListRef.current.scrollTo({top:menuListRef.current.scrollHeight,behavior:"smooth"});
  }, [phase]);
  ...
  const BrowserView = () => (
    <div style={{height:"100%",background:"#fafafa",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:"white",padding:"6px 8px",display:"flex",alignItems:"center",gap:6,borderBottom:"1px solid #dadce0",flexShrink:0}}>
        ...
        <div ref={menuRef} style={{padding:"2px 2px"}}>
          <div style={{display:"flex",flexDirection:"column",gap:2}}>
            <div style={{width:3,height:3,borderRadius:"50%",background:"#5f6368"}}/>
            <div style={{width:3,height:3,borderRadius:"50%",background:"#5f6368"}}/>
            <div style={{width:3,height:3,borderRadius:"50%",background:"#5f6368"}}/>
          </div>
        </div>
  ...
  const HomeScreen = () => (
    <div style={{background:"linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%)",height:"100%",display:"flex",flexDirection:"column",animation:"fadeIn 0.5s"}}>
      <div style={{padding:"6px 12px",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
        <span style={{fontSize:9,color:"white",fontWeight:500}}>18:32</span>
        <div style={{display:"flex",gap:3,alignItems:"center"}}>
          <div style={{padding:"1px 4px",borderRadius:3,border:"1px solid white",fontSize:7,color:"white",fontWeight:700}}>87</div>
        </div>
      </div>
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 24px"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,width:"100%",maxWidth:280}}>
          {[
            {name:"Chrome",bg:"white"},{name:"Gmail",bg:"white"},{name:"Maps",bg:"white"},{name:"Foto",bg:"white"},
            {name:"WhatsApp",bg:"#25d366"},{name:"Telegram",bg:"#0088cc"},{name:"ChatGPT",bg:"white"},{name:"Claude",bg:"#f97316"},
            {name:"Banca",bg:"#1a73e8"},{name:"Spotify",bg:"#1db954"},{name:"YouTube",bg:"white"},
            {name:"CleaningApp",bg:"transparent",isNew:true},
          ].map((app,i)=>(
            <div key={i} style={{textAlign:"center"}}>
              <div style={{width:48,height:48,borderRadius:14,margin:"0 auto 4px",background:app.bg,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.2)",position:"relative",animation:app.isNew?"pulse 1.5s ease-in-out infinite":"none",border:app.isNew?"2px solid rgba(255,255,255,0.5)":"none",overflow:"hidden"}}>
                {app.isNew ? <img src={APP_ICON} style={{width:48,height:48,borderRadius:14}} alt="" /> : <span style={{fontSize:18}}>{["\ud83c\udf10","\ud83d\udce7","\ud83d\uddfa\ufe0f","\ud83d\uddbc\ufe0f","\ud83d\udcac","\u2708\ufe0f","\ud83e\udd16","\u2728","\ud83c\udfe6","\ud83c\udfb5","\u25b6\ufe0f",""][i]}</span>}
                {app.isNew && <div style={{position:"absolute",top:-4,right:-4,width:12,height:12,borderRadius:"50%",background:"#34a853",border:"2px solid white",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:7,color:"white",fontWeight:900}}>\u2713</span></div>}
              </div>
              <span style={{fontSize:7,color:"white",fontWeight:app.isNew?700:400,textShadow:"0 1px 2px rgba(0,0,0,0.5)"}}>{app.name}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  const menuItems = ["Scheda in incognito","Cronologia","Download","Preferiti","Schede recenti","Condividi...","Trova nella pagina","Traduci...","Aggiungi a schermat...","Sito desktop"];

  return (
    <div ref={ref} style={{position:"relative",height:"100%",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      <CompletionOverlay visible={phase>=9} message="App Installata!" />
      {vis && activeRef && !showHome && <SmartCursor targetRef={activeRef} clicking={clicking} visible={phase>=1&&phase<8} />}
      {showHome ? <HomeScreen /> : <BrowserView />}
      {phase>=3 && phase<6 && !showHome && (
        <div ref={menuListRef} style={{position:"absolute",top:32,right:4,bottom:40,background:"white",borderRadius:4,boxShadow:"0 2px 12px rgba(0,0,0,0.2)",width:200,zIndex:10,animation:"fadeIn 0.15s",overflow:"auto",padding:"6px 0"}}>
          {menuItems.map((t,i)=>(
            <div key={i} ref={i===8?addHomeRef:undefined} style={{padding:"9px 14px",fontSize:10,color:i===8&&phase>=4?"#1a73e8":"#3c4043",fontWeight:i===8&&phase>=4?500:400,background:i===8&&phase>=4?"#e8f0fe":"transparent"}}>
              {t}
            </div>
          ))}
        </div>
      )}
      {phase>=6 && phase<8 && !showHome && (
        <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:20,animation:"fadeIn 0.2s"}}>
          <div style={{background:"white",borderRadius:28,padding:"24px 24px 16px",width:"85%",boxShadow:"0 8px 30px rgba(0,0,0,0.3)"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:16,padding:12,background:"#f8f9fa",borderRadius:12}}>
              <div style={{width:36,height:36,borderRadius:8,overflow:"hidden",flexShrink:0}}><img src={APP_ICON} style={{width:36,height:36}} alt="" /></div>
              <div>
            ...
            <div style={{display:"flex",justifyContent:"flex-end",gap:8}}>
              ...
              <button ref={addBtnRef} style={{padding:"8px 24px",borderRadius:20,border:"none",background:phase>=7?"#34a853":"#1a73e8",fontSize:11,fontWeight:500,color:"white",transition:"all 0.2s"}}>{phase>=7?"\u2713 Aggiunto":"Aggiungi"}</button>
            </div>
          </div>
        </div>
      )}
