      ...
      try {
        ...
        const myBookings = allBookings
          ...
          .map(b => ({
            ...
            // @ts-expect-error TODO-FIX: TS2339 Property 'adults' does not exist on type 'Booking'.
      ...
      {bookings.length > 0 ? (
        <div className="space-y-4">
          {bookings.map((booking) => {
            ...
            const isTodayCheckout = isSameDay(checkOutDate, today);
            const isTomorrowCheckout = isSameDay(checkOutDate, tomorrow);
            const needsGuests = !booking.guestsCount;
            const isUrgent = needsGuests && (isTodayCheckout || isTomorrowCheckout);
