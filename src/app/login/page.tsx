...
// 🔥 FIX: Helper che considera ANCHE gli stati di onboarding
function getDestinationByUser(user: any): string {
...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col overflow-hidden" style={{ overscrollBehavior: "none" }}>
      <div className="flex-1 flex overflow-y-auto overscroll-none" style={{ WebkitOverflowScrolling: "touch" }}>
        {/* Left Side - Branding */}
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full pl-12 pr-12 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 outline-none transition-all"
                      required
                    />
                    <button
                      type="button"
              ...
              <div className="mt-4 text-center">
                <Link href="/forgot-password" className="text-sm text-slate-400 hover:text-sky-400 transition-colors">
              ...
              {/* Demo Buttons - solo in development */}
