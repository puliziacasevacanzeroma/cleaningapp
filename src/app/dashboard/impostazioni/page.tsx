        ...
        {user?.role === 'ADMIN' && (
          <div className="bg-white rounded-xl border border-slate-200 p-4 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              {/* Contratti */}
              <a 
                href="/dashboard/impostazioni/contratti"
                className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl hover:border-amber-300 hover:bg-amber-50 transition-colors group"
              >
                ...
                <div>
                  <p className="font-semibold text-slate-800">Contratti</p>
                  <p className="text-xs text-slate-500">Quadro, Allegati, Template</p>
                </div>
                <svg className="w-5 h-5 text-slate-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              {/* Proprietà PENDING — diagnostica e cancellazione */}
              <a 
                href="/dashboard/debug-pending"
                className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl hover:border-rose-300 hover:bg-rose-50 transition-colors group"
              >
                ...
                <div>
                  <p className="font-semibold text-slate-800">Proprietà PENDING</p>
                  <p className="text-xs text-slate-500">Diagnostica ed elimina proprietà in attesa</p>
                </div>
                <svg className="w-5 h-5 text-slate-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
