...
export type NotificationType = 
  ...
  | "PROPERTY_CHANGE_REQUEST" // Richiesta modifica proprietà
  ...
  | "LINEN_DELIVERED"         // Biancheria consegnata a operatore
  | "ORDER_DELIVERED"         // Ordine consegnato
  | "PRODUCT_REQUEST"         // Richiesta prodotti pulizia
  | "GUEST_COUNT_MISSING"     // Numero ospiti mancante
  | "GUEST_COUNT_APPLIED"     // Numero ospiti applicato automaticamente
  ...
  | "APPROVAL_REQUEST"        // Richiesta approvazione utente
  | "SYSTEM"                  // Notifica di sistema
  | "INFO"                    // Informazione generica
  | "WARNING"                 // Avviso
  | "URGENT"                  // Avviso urgente
  | "SUCCESS"                 // Successo
  | "ERROR"                   // Errore
  | string;                   // Fallback per tipi legacy
...
export interface FirebaseNotification {
  ...
  // Campi legacy per compatibilità (usati da issues route)
  relatedType?: string;
  relatedId?: string;
  data?: any;
