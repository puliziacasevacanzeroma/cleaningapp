...
export const PaymentActionSchema = z.object({
  ...
  month: z.union([z.string(), z.number()]).transform(v => typeof v === "string" ? parseInt(v, 10) : v).optional(),
  year: z.union([z.string(), z.number()]).transform(v => typeof v === "string" ? parseInt(v, 10) : v).optional(),
