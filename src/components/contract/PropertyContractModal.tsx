...
export function PropertyContractModal({ isOpen, property, user, onClose, onSuccess }: PropertyContractModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-[9999] flex items-end sm:items-center justify-center sm:p-4" style={{ paddingBottom: 0 }}>
      <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-2xl sm:h-[92dvh] flex flex-col shadow-2xl overflow-hidden" style={{ height: "95dvh", maxHeight: "95dvh" }}>
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          {loading ? (
            ...
            <>
              ...
              {/* Action */}
              <div className="px-6 pt-4 border-t flex-shrink-0" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 1rem)" }}>
                <button
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {/* Actions */}
              <div className="px-6 pt-4 border-t flex gap-3 flex-shrink-0 sticky bottom-0 bg-white" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 1rem)" }}>
