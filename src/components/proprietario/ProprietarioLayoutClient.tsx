...
export function ProprietarioLayoutClient({ children, userName, userEmail }: ProprietarioLayoutClientProps) {
  ...
  // Inizia con null per evitare hydration mismatch
  ...
  const menuItems = [
    ...
    { href: "/proprietario/impostazioni", label: "Altro", icon: SettingsIcon },
  ];

  // Loading state - mostra uno schermo vuoto mentre determiniamo mobile/desktop
  if (isMobile === null) {
    return (
            ...
            >
              <nav style={{ padding: '16px' }}>
                {menuItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <item.icon />
                      <span>{item.label === "Altro" ? "Impostazioni" : item.label}</span>
                    </Link>
                  );
                })}
              </nav>
              ...
              <div style={{ 
                ...
                <Link
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', color: '#dc2626', borderRadius: '8px', textDecoration: 'none' }}
                >
                  <LogoutIcon />
                  <span>Esci</span>
                </Link>
      ...
      <aside style={{ 
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid #e2e8f0' }}>
          <Link href="/proprietario" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
            ...
            <div>
              <h1 style={{ fontWeight: 'bold', color: '#1e293b', margin: 0, fontSize: '16px' }}>CleaningApp</h1>
