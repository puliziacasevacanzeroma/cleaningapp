  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-sky-50/30">
      <div className="flex h-full">
        ...
        <aside className="w-72 h-screen bg-white/80 backdrop-blur-xl border-r border-slate-200/60 fixed flex flex-col">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <div className="pt-2">
              ...
              {openMenus.calendari && (
                <div className="ml-6 space-y-1 border-l-2 border-slate-200 pl-4">
                  <Link href="/proprietario/calendario/prenotazioni" className={`flex items-center px-3 py-2.5 rounded-lg text-sm transition-colors ${isActive("/proprietario/calendario/prenotazioni") ? "bg-sky-50 text-sky-600" : "text-slate-500 hover:bg-slate-50"}`}>
                  ...
                  <Link href="/proprietario/calendario/pulizie" className={`flex items-center px-3 py-2.5 rounded-lg text-sm transition-colors ${isActive("/proprietario/calendario/pulizie") ? "bg-sky-50 text-sky-600" : "text-slate-500 hover:bg-slate-50"}`}>
            ...
            <div className="pt-2">
              ...
              {openMenus.proprieta && (
                <div className="ml-6 space-y-1 border-l-2 border-slate-200 pl-4">
                  <Link href="/proprietario/proprieta" className={`flex items-center px-3 py-2.5 rounded-lg text-sm transition-colors ${isActive("/proprietario/proprieta") && !pathname.includes("nuova") ? "bg-sky-50 text-sky-600" : "text-slate-500 hover:bg-slate-50"}`}>
                    <span className="w-2 h-2 rounded-full bg-emerald-400 mr-3"></span>Le mie proprietà
                  </Link>
                  <Link href="/proprietario/proprieta/nuova" className={`flex items-center px-3 py-2.5 rounded-lg text-sm transition-colors ${isActive("/proprietario/proprieta/nuova") ? "bg-sky-50 text-sky-600" : "text-slate-500 hover:bg-slate-50"}`}>
            ...
            <div className="pt-2">
              <Link 
                href="/proprietario/report" 
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                  isActive("/proprietario/report")
                    ? "text-white bg-gradient-to-r from-sky-500 to-blue-600 shadow-lg shadow-sky-500/30" 
                    : "text-slate-500 hover:bg-slate-50"
                }`}
              >
          ...
          <div className="p-4 border-t border-slate-200/60 flex-shrink-0">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100/50 border border-slate-200/60">
              ...
              <a href="/api/auth/signout" className="p-2 hover:bg-slate-200/50 rounded-lg transition-colors" title="Logout">
        ...
        {/* Main Content - OVERFLOW-X BLOCCATO */}
