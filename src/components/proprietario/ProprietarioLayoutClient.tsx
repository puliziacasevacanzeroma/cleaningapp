...
export function ProprietarioLayoutClient({ children, userName, userEmail }: ProprietarioLayoutClientProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-slate-200 z-50 lg:hidden">
      ...
      {/* DESKTOP SIDEBAR - solo su schermi grandi */}
      <aside className="hidden lg:flex w-72 h-screen bg-white border-r border-slate-200 fixed flex-col">
      ...
      <main className="pt-14 pb-20 lg:pt-0 lg:pb-0 lg:ml-72">
        <div className="hidden lg:block h-16 bg-white border-b border-slate-200 px-6 sticky top-0 z-30">
          <div className="flex items-center justify-end h-full gap-3">
            <div className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-slate-100">
      ...
      {/* MOBILE BOTTOM NAV - solo su schermi piccoli */}
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-[70] lg:hidden p-6">
