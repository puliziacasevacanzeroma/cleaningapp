          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveItem} className="p-5 space-y-4">
              ...
              <label className="flex items-center gap-3 p-3.5 bg-slate-50 rounded-xl cursor-pointer border border-slate-200">
                ...
                <div><span className="text-sm font-semibold text-slate-700">Articolo gestito dalla lavanderia</span><p className="text-xs text-slate-500 leading-relaxed mt-0.5">Se attivo: l'articolo entra nei conteggi della pagina Lavanderia (richiesti/consegnati/costi) ed è visibile nel configuratore dotazioni. Se spento: non arriva mai alla lavanderia, di qualunque categoria sia.</p></div>
              </label>
