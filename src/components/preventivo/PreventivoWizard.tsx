    ...
    <div className="pv-widget">
      <aside className="pv-side">
        <div className="pv-side-top">
          ...
          <a href="https://puliziacasevacanze.it" className="pv-brand" aria-label="Torna al sito Puliziacasevacanze.it">
            {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <a className="pv-back-sito" href="https://puliziacasevacanze.it">← Torna al sito</a>
        </div>
      ...
      <div className="pv-main">
        <div className="pv-head">
          ...
          <a className="pv-back-sito pv-back-sito--mobile" href="https://puliziacasevacanze.it">← Sito</a>
