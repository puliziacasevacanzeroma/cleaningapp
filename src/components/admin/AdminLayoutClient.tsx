      ...
      <div className="flex">
        ...
        <aside className="w-72 min-h-screen bg-white/80 backdrop-blur-xl border-r border-slate-200/60 fixed">
          ...
          <nav className="p-4 space-y-1">
            <Link href="/admin" className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${pathname === "/admin" ? "text-white bg-gradient-to-r from-sky-500 to-blue-600 shadow-lg shadow-sky-500/30" : "text-slate-500 hover:bg-slate-50"}`}>
              <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${pathname === "/admin" ? "bg-white/20" : ""}`}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Calendari */}
            <div className="pt-2">
              <button onClick={() => setExpandedMenu(expandedMenu === "calendari" ? null : "calendari")} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 cursor-pointer transition-colors">
              ...
              {expandedMenu === "calendari" && (
                <div className="ml-6 space-y-1 border-l-2 border-slate-200 pl-4">
                  <Link href="/admin/calendario/prenotazioni" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
                    <span className="w-2 h-2 rounded-full bg-slate-300 mr-3"></span>Prenotazioni
                  </Link>
                  <Link href="/admin/calendario/pulizie" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
            ...
            {/* Proprietà */}
            <div className="pt-2">
              <button onClick={() => setExpandedMenu(expandedMenu === "proprieta" ? null : "proprieta")} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 cursor-pointer transition-colors">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {expandedMenu === "proprieta" && (
                <div className="ml-6 space-y-1 border-l-2 border-slate-200 pl-4">
                  <Link href="/admin/proprieta" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
                    <span className="w-2 h-2 rounded-full bg-slate-300 mr-3"></span>Attive
                  </Link>
                  <Link href="/admin/proprieta/pending" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
            ...
            {/* Utenti */}
            <div className="pt-2">
              <button onClick={() => setExpandedMenu(expandedMenu === "utenti" ? null : "utenti")} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 cursor-pointer transition-colors">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {expandedMenu === "utenti" && (
                <div className="ml-6 space-y-1 border-l-2 border-slate-200 pl-4">
                  <Link href="/admin/utenti/proprietari" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
                    <span className="w-2 h-2 rounded-full bg-slate-300 mr-3"></span>Proprietari
                  </Link>
                  <Link href="/admin/utenti/operatori" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-slate-500 hover:bg-slate-50">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200/60">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100/50 border border-slate-200/60">
              ...
              <button onClick={handleLogout} className="p-2 hover:bg-slate-200/50 rounded-lg transition-colors">
